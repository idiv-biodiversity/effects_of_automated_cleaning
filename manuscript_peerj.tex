...
\author[5]{Tiago Andrade Borges Santos}

\author[6]{Andressa Cabral}

\author[7]{Filipe Cabreirinha Serrano}
...
\author[9]{Moabe Ferreira Fernandes}
...
\author[8]{Mabel Rocio Baez-Lizarazo}

\author[6]{Tiago Luiz Vieira}
...
\affil[5]{Universidade Estadual de Feira de Santana, Feira de Santana, Brazil}
\affil[6]{Departamento de Botânica, Universidade de São Paulo, São Paulo, Brazil}
\affil[7]{Departamento de Ecologia, Universidade de São Paulo, São Paulo, Brazil}
\affil[8]{Universidade Federal do Rio Grande do Sul, Porto Alegre, Brazil}
\affil[9]{Departamento de Ciências Biológicas, Universidade Estadual de Feira de Santana, Feira de Santana, Brazil}
...
\begin{figure}
\includegraphics[width=0.9\linewidth]{./figures_tables/Figure_study_groups} \caption{Examples of study taxa. \textbf{A)} Pilosocereus pusillibaccatus, picture by Pamela Lavor; \textbf{B)} Conchocarpus macrocarpus, Juliana El-Ottra; \textbf{C)} Tillandsia recurva, EC Tomaz; \textbf{D)} \textit{Oxyrhopus guibei} (Dipsadidae), Filipe C Serrano; \textbf{E)} Neanuridae (\textit{Aethiopella ricardoi}), Raiane Vital da Paz; \textbf{F)} \textit{Tocoyena formosa}, Fernanda GL Moreira; \textbf{G)} \textit{Harengula jaguana}, Thais Ferreira-Araujo; \textbf{H)} \textit{Gaylussacia decipiens}, Luiz Menini Neto; \textbf{I)} \textit{Ooocephalus foliosus}, Arthur Soares; \textbf{J)} \textit{Tityus carvalhoi}, Renata C Santos-Costa; \textbf{K)} \textit{Prostheca vespa}, Tiago Veira}\label{fig:species}
\end{figure}

\begin{figure}
\includegraphics[width=\linewidth]{./output/figure_number_of_records} \caption{The difference in records available between the raw and filtered dataset of 18 Neotropical taxa including animals, funghi, and plants, plotted in a 100x100 km grid across the Neotropics.}\label{fig:total}
\end{figure}
